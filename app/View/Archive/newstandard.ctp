...
$requst=$this->requestAction('archive/getNewsId/'.$id.'/'.$date.'/'.$standard);
...
$ft=$this->requestAction('archive/getNewsContent/'.$newsid.'/'.$date.'/'.$standard);
if($ft){
?>
...
<?php $result=$this->requestAction('/archive/findmostView/'.$date.'/'.$standard);
